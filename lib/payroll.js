document.addEventListener("DOMContentLoaded", () => {
  ...
  function update(filter) {
    ...
    d3.csv(
      "https://etrinidad132.github.io/Price-of-Winning/data/payroll.csv",
      function (data) {
        data.forEach((team) => {
        ...
        logos
          ...
          .attr("xlink:href", function (d) {
            return `https://etrinidad132.github.io/Price-of-Winning/images/team/${d.Code}.png`; // cycles image for the top of the team line based on the teams unique code
          });
